...
## 1. Online Sales: multiply all online sales channels (online_sales)
...
## 2. Profit per item: retail price minus BOM cost (profit_per_item)
...
## 3. BOM Cost per Component (bompercomp)
...
## 4. Total cost: units sold times BOM cost (total_cost)
...
## 7. Winter vs Summer: ratio of seasonal sales (winter_summer_ratio)
...
## 8. Material premium (material_premium)
...
## 9-10. Cleaned Columns to be used (instore,direct_to_consumer)
